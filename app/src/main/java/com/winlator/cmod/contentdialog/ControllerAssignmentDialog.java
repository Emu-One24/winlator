...
public class ControllerAssignmentDialog {
    ...
    /**
     * Legacy call (e.g., from MainActivity). Will try to grab WinHandler if context
     * is XServerDisplayActivity.
     */
    ...
    private ControllerAssignmentDialog(Activity activity, int initialPlayerCount, WinHandler winHandler) {
        ...
        ContextThemeWrapper themed = new ContextThemeWrapper(activity, dark ? R.style.ContentDialog : R.style.AppTheme);
        ...
        if (dark) {
            ...
            if (root instanceof ViewGroup)
                setTextColorForDialog((ViewGroup) root, 0xFFFFFFFF);
        }
    ...
    private void initializeViews() {
        ...
        // com.winlator.cmod.contentdialog.MacrosDialog.show(hostActivity, 0,
        // winHandler));
        btnMacros[0].setVisibility(View.GONE);
        ...
        // com.winlator.cmod.contentdialog.MacrosDialog.show(hostActivity, 1,
        // winHandler));
        btnMacros[1].setVisibility(View.GONE);
        ...
        // com.winlator.cmod.contentdialog.MacrosDialog.show(hostActivity, 2,
        // winHandler));
        btnMacros[2].setVisibility(View.GONE);
        ...
        // com.winlator.cmod.contentdialog.MacrosDialog.show(hostActivity, 3,
        // winHandler));
        btnMacros[3].setVisibility(View.GONE);
    }
